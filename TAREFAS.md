...
- [x] 1. Definir arquitetura da extensao
...
- [x] 2. Criar estrutura inicial do projeto
...
- [x] 3. Implementar configuracao de dominios monitorados
...
- [x] 4. Capturar requests continuamente no background
...
- [x] 5. Implementar janela destacada de monitoramento
...
- [x] 6. Filtrar requests relevantes Pluzo
...
- [x] 7. Implementar parser de headers de cache
...
- [x] 8. Classificar origem provavel de cada request
...
- [x] 9. Detectar sinais de browser cache
...
- [x] 10. Montar UI do relatorio e painel complementar
...
- [x] 11. Implementar painel DevTools opcional
...
- [x] 12. Implementar alertas de politica Pluzo
...
- [x] 13. Adicionar exportacao local de diagnostico
...
- [x] 14. Documentar instalacao e uso
...
- [x] 16. Revisar permissoes e privacidade
...
- [x] 17. Preparar pacote de distribuicao interna
